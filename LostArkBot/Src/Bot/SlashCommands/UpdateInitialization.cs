...
{
    internal class UpdateInitialization
    {
        public static SlashCommandBuilder Update()
        {
            SlashCommandBuilder updateCommand = new SlashCommandBuilder()
                                                    .WithName("update")
                                                    ...
                                                    .AddOption(new SlashCommandOptionBuilder()
                                                               ...
                                                               .AddChoice("Lance Master", "Lance Master")
