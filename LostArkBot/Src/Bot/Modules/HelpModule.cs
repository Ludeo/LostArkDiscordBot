    ...
    internal class HelpModule
    {
        public static async Task HelpAsync(SocketSlashCommand command)
        {
            EmbedBuilder embed = new EmbedBuilder()
            {
                ...
                $"**/edittime [time]**\nEdits time of the lfg event, has to be in this format: MM/DD hh:mm\n\n" +
                ...
                $"**/updatemeta [twitch-name]**\nUpdates the currently online character with information from meta-agem with the given twitch-name\n\n" +
