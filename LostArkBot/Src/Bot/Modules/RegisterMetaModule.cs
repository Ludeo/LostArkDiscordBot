...
{
    internal class RegisterMetaModule
    {
        public static async Task RegisterMetaAsync(SocketSlashCommand command)
        {
            ...
            {
                await command.RespondAsync(text: characterCheck.CharacterName + " is already registered. You can update it with **/update**", ephemeral: true);
            ...
            Character character = new()
            {
                ...
                CustomProfileMessage = string.Empty,
            ...
            {
                await command.RespondAsync(text: character.CharacterName + " does not exist. Login with the character and enable the twitch extension", ephemeral: true);
            ...
            await command.RespondAsync(text: $"{character.CharacterName} got successfully registered", embed: embedBuilder.Build());
        }
    }
}
