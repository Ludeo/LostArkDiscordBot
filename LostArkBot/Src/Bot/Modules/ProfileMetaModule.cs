...
{
    internal class ProfileMetaModule
    {
        public static async Task ProfileMetaModuleAsync(SocketSlashCommand command)
        {
            ...
            {
                await command.RespondAsync(text: characterName + " does not exist. Login with the character and enable the twitch extension", ephemeral: true);
            ...
            await command.Channel.SendFileAsync("image.png");
            //await command.RespondWithFileAsync("image.png", "test_image.png");
        }
    }
}
