...
public class LostArkBotContext : DbContext
{
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
            ...
            modelBuilder.Entity<ChallengeAbyss>(
                                                entity =>
                                                {
            ...
            modelBuilder.Entity<ChallengeGuardian>(
                                                   entity =>
                                                   {
            ...
            modelBuilder.Entity<StaticGroup>(
                                             entity =>
                                             {
                                                   ...
                                                   entity.HasMany(d => d.Characters)
                                                         ...
                                                         .UsingEntity<Dictionary<string, object>>(
                                                                                                  ...
                                                                                                  l => l.HasOne<Character>()
                                                                                                        .WithMany()
                                                                                                        .HasForeignKey("CharacterId")
                                                                                                        .OnDelete(DeleteBehavior.ClientSetNull)
                                                                                                        .HasConstraintName("staticgroupusersfk2"),
                                                                                                  r => r.HasOne<StaticGroup>()
                                                                                                        .WithMany()
                                                                                                        .HasForeignKey("StaticGroupId")
                                                                                                        .OnDelete(DeleteBehavior.ClientSetNull)
                                                                                                        .HasConstraintName("staticgroupusersfk1"),
                                                                                                  j =>
                                                                                                  {
                                                                                                        j.HasKey(
                                                                                                               "StaticGroupId",
                                                                                                        ...
                                                                                                        j.HasIndex(
                                                                                                         new[] { "CharacterId" },
                                                                                                         "staticgroupusersfk2_idx");

                                                                                                        j.IndexerProperty<int>("StaticGroupId")
                                                                                                              .HasColumnType("int(11)")
                                                                                                              .HasColumnName("staticGroupId");
